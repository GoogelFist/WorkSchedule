...
class GenerateNextMonthTwoInTwoUseCase @Inject constructor(private val workDaysGenerator: WorkTwoInTwoMonthGenerator) {
    operator fun invoke(firstWorkDate: LocalDate): Month {
        return workDaysGenerator.generateNextMonth(firstWorkDate)
    }
}